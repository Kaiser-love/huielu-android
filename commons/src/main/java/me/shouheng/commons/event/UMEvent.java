...
public interface UMEvent {
    ...
    String PAGE_ALBUM = "album_activity";
    String PAGE_CAMERA = "camera_activity";

    /* page  fragment */
    String PAGE_WORK_TO_DO = "work_to_do_fragment";
    String PAGE_WORK__FINISH = "work_finish_fragment";
