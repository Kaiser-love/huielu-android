...
public class PermissionUtils {
    ...
    public static final int MODIFY_AUDIO_SETTINGS = 5;
    ...
    public static class Permission {
        ...
        public static final int MODIFY_AUDIO_SETTINGS = 0xFF0A;
        public static final int RECORD_AUDIO = 0xFF0B;
    }
    ...
    public static String map(int permission) {
        switch (permission) {
            ...
            case Permission.MODIFY_AUDIO_SETTINGS: return Manifest.permission.MODIFY_AUDIO_SETTINGS;
            case Permission.RECORD_AUDIO: return Manifest.permission.RECORD_AUDIO;
