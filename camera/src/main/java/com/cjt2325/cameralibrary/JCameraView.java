...
public class JCameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder
    ...
    private ClickListener rightLongClickListener;
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        initData();
        initView();
//        setRightClickListener(new ClickListener() {
//            @Override
//            public void onClick() {
//                switch (recordState) {
//                    case 0:
//                        recordManager.start();
//                        mCaptureLayout.setRightIconSrc(R.drawable.ic_camera);
//                        recordState = 1;
//                        break;
//                    case 1:
//                        recordManager.pause();
//                        mCaptureLayout.setRightIconSrc(R.drawable.ic_flash_off);
//                        recordState = 2;
//                        break;
//                    case 2:
...
//            }
//        });
//        setRightLongClickListener(new ClickListener() {
//            @Override
//            public void onClick() {
...
//        });
        ...
        mCaptureLayout.setRightLongClickListener(new ClickListener() {
            @Override
            public void onClick() {
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void setRightLongClickListener(ClickListener clickListener) {
        this.rightLongClickListener = clickListener;
    }
