 ...
 */
public class SoundAdapter extends RecyclerView.Adapter<SoundAdapter.FullDelDemoVH> {
    private Context mContext;
    private LayoutInflater mInfalter;
    private List<SoundBean> mDatas;

    public SoundAdapter(Context context, List<SoundBean> mDatas) {
        mContext = context;
    ...
    public FullDelDemoVH onCreateViewHolder(ViewGroup parent, int viewType) {
        return new FullDelDemoVH(mInfalter.inflate(R.layout.item_sound, parent, false));
    }
    ...
    public List<SoundBean> getmDatas() {
        return mDatas;
    }

    public void setmDatas(List<SoundBean> mDatas) {
        this.mDatas = mDatas;
    }
