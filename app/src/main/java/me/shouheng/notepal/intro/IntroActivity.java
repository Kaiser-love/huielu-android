...
public class IntroActivity extends AppIntro2 {
    ...
    public void onDonePressed() {
        PalmApp.getContext().getSharedPreferences(Constants.PREFS_NAME, Context.MODE_MULTI_PROCESS).edit()
    ...
    public static boolean mustRun() {
        return !PalmApp.getContext().getSharedPreferences(Constants.PREFS_NAME,
