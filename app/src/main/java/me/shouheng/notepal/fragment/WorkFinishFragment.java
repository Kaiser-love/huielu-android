...
import me.shouheng.notepal.databinding.FragmentWorkFinishBinding;
 ...
 */
@PageName(name = UMEvent.PAGE_WORK__FINISH)
public class WorkFinishFragment extends BaseFragment<FragmentWorkFinishBinding> implements BaseQuickAdapter.OnItemClickListener {
    ...
    protected int getLayoutResId() {
        return R.layout.fragment_work_finish;
    }
